...
| **Darkmoon** | Autonomous offensive engine with per-technology sub-agents across web, cloud, Active Directory and Kubernetes; validates findings with real exploit execution and keeps a full evidence trail. A Privacy Gateway masks real IPs, hosts and credentials from the model via deterministic placeholders. | Python | Local LLM | CLI | [Link](https://github.com/ASCIT31/Dark-Moon) |
